                    ...
                    <div class="content" style="padding: 20px 30px;">
                        ...
                        <div>
                            ...
                            <img src="{{ asset('storage/images/' . $books->image) }}"
                                style="width: 100%; height: 200px; margin: 20px 0 20px 0; object-fit:contain;">
                            @else
                            @endif
                        </div>
                        <div>
                            @if(!empty($books->text))
                            <p
                                style="white-space: pre-wrap; width: 100%; text-indent: 0.3in; margin: 20px 0 0 0; font-size: 14px;">
                                {{ $books->text }}</p>
                            @else
                            @endif
                        </div>
