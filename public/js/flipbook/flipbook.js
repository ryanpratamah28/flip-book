...
!(function (a) {
    ...
    (b.version = "5.0.0"),
        ...
        (b.calculateBounds = function (a) {
            ...
            if (b.width > a.boundWidth || b.height > a.boundHeight) {
                ...
                a.boundWidth / c > a.boundHeight &&
                a.boundHeight * c <= a.boundWidth
        ...
        (b.Event = function (c, d) {
            ...
            return (
                (d._triggerVirtualEvent = function (a) {
                    e != a.timeStamp &&
                        ((e = a.timeStamp), this.$el.trigger(a));
                }),
            ...
            a.event.special[c] = {
                ...
                remove: function (b) {
                    ...
                    g &&
                        ...
                        (g.listeners--,
                        0 === g.listeners &&
                            (g.instance._remove(), delete g.instance));
                },
            };
        }),
                ...
                c
                    ? (this.$el.on(
                      ...
                      this.$el.on(
                          "touchend",
                          this._selector,
                          a.proxy(this, "_touchend")
                      ))
                    : this.$el.on(
                          "click",
                          this._selector,
                          a.proxy(this, "_trigger")
                      );
            },
            _remove: function () {
                c
            ...
            _touchend: function () {
                if (this._data.startEvent) {
                    ...
                    if (
                        b.isInside(
                            c,
                            this._data.startEvent.currentTarget || this.el
                        ) &&
            ...
            _tap: function (a) {
                ...
                if ((c.shift(), c.push(a.timeStamp), c[1] - c[0] < 300)) {
                    ...
                    this._triggerVirtualEvent(
                        this.Event(d, { pageX: e.x, pageY: e.y })
                    );
                }
            },
        }),
    ...
    (q.prototype._cornerAllowed = function () {
                ...
                if (a) {
                    ...
                    if (
                        ...
                        if (
                            ...
                            c.ogradient
                                .show()
                                .css({ zIndex: 2, visibility: "visible" }),
                            e && h.tPage != c.page)
                        ) {
                ...
                if (!f || !d.point || d.point.corner != a.corner) {
                    if (
                        ...
                        this._trigger(
                            "start",
                            d.page,
                            i.tpage ? null : a.corner
                        ) == b.EVENT_PREVENTED)
                    )
                        return !1;
                    if (
                        i.pages[d.next] &&
                        d.effect != i.pages[d.next].data("f").effect
                    )
                        return !1;
                    ...
                    f ||
                        (i.front.push(
                            i.display == b.DISPLAY_SINGLE ? 0 : d.next
                        ),
        ...
        (q.prototype.turnPage = function (c) {
            ...
            if (
                ...
                h.display == b.DISPLAY_SINGLE &&
                    -1 == a.inArray(c, b.corners.forward))
            ) {
        ...
        (q.prototype.peel = function (c, d) {
            ...
            if (c.corner) {
                if (-1 == a.inArray(c.corner, b.corners.all))
                    throw b.turnError(
                        "Corner " + c.corner + " is not permitted"
                    );
                if (~a.inArray(c.corner, this._cornerAllowed())) {
                    ...
                    (e.peel = c),
                        (e.status = "peel"),
                        this._showFoldedPage(
                            b.peelingPoint(c.corner, h.x, h.y),
                            d
                        );
                }
        ...
        (n.prototype._makeRange = function () {
            ...
            if (b.totalPages > 0)
                for (
                    b.range = this.range(), a = b.range[0];
                    a <= b.range[1];
                    a++
                )
        ...
        (n.prototype.removePage = function (a) {
            ...
            if ("*" == a) {
                ...
                if (
                    c.pageObjs[a] &&
                    (this.stop(), !this._removePageFromDOM(a, !0))
                )
                    return !1;
                this._movePages(a, -1),
        ...
        (n.prototype.view = function (a, b) {
            ...
            return (
                b
                    ? (d[0] > 0 && e.push(d[0]),
                      d[1] <= c.totalPages && e.push(d[1]))
                    : (d[0] > 0 ? e.push(d[0]) : e.push(0),
                      d[1] &&
                          (d[1] <= c.totalPages ? e.push(d[1]) : e.push(0))),
                e
            );
        }),
        ...
        (n.prototype._missing = function (a) {
            ...
            if (b.totalPages < 1)
                return (
                    b.options.blocks > 0 && this.$el.trigger("missing", [1]),
                    void 0
                );
            for (
                var c = b.range || this.range(a), d = [], e = c[0];
                e <= c[1];
                e++
            )
                ...
                if (a > d.options.pages) {
                    if (c) {
                        ...
                        d.display == b.DISPLAY_DOUBLE
                            ? d.options.showDoublePage
                                ? 1 == a % 2 &&
                                  (e = Math.ceil((a - d.options.pages + 1) / 2))
                                : 0 === a % 2 &&
                                  (e = Math.ceil((a - d.options.pages + 2) / 2))
                            : (e = a - d.options.pages);
        ...
        (n.prototype._fetchBlocks = function (a) {
            ...
            if (c.options.blocks && c.pageBlocks[a]) {
                ...
                if (d.status == b.fragStatus.assigned)
                    ...
                    if (
                        a > e[0] &&
                        (this._cleanPages(a + 1, this.range()[1]),
                        d.nextPageTmp)
                    ) {
        ...
        (n.prototype._flowContent = function (c, d) {
            ...
            if (f && g) {
                ...
                if (v)
                    if (
                        ...
                        if (((h.status = b.fragStatus.full), u)) {
                            ...
                            (h.last = v.path[0] + h.first),
                                (t.first = h.last),
                                (t.last =
                                    t.first + r.children("div").length - 1);
                    ...
                    ((f.end = c), (h.status = b.fragStatus.waiting), c < l[0])
                ) {
        ...
        (n.prototype._reportLoading = function (a) {
            for (
                var b = this._data, c = this.view(a, !0), d = 0;
                d < c.length;
                d++
            )
                c[d] >= a &&
        ...
        (n.prototype.replaceView = function (a, c) {
            ...
            if (a != c && a >= e[0] && a <= e[1]) {
                ...
                (d.pageObjs = o),
                    ...
                    (d.page = d.page - a + c),
                    d.tpage &&
                        ((d.tpage = d.tpage - a + c), (d.page = d.tpage)),
                    this._missing(c),
                    this.update(),
        ...
        (n.prototype._turnPage = function (c, d) {
            ...
            if (
                ...
                if (
                    ...
                    return (
                        ~a.inArray(e, h.pageMv) &&
                            h.pages[e].flip("hideFoldedPage", !0),
                        !1
                    );
                ~a.inArray(1, j)
                    ? (this.$el.addClass("first-page"),
        ...
        (n.prototype._resizeObserver = function () {
            ...
            if (b && b.watchSizeChange) {
                ...
                (b.viewerWidth != c.width() || b.viewerHeight != c.height()) &&
                    ...
                    this._resize()),
                    (b.monitorTimer = setTimeout(
                        a.proxy(this._resizeObserver, this),
                        d
                    ));
            }
        }),
        ...
        (n.prototype._defaultSize = function (a) {
            var c = this._data,
                ...
                f =
                    "string" == typeof c.options.width &&
                    ~c.options.width.indexOf("%"),
        ...
        (n.prototype._calculateMargin = function () {
            ...
            (a = d.options.margin)
                ...
                (a = d.options.pageMargin)
                    ? (c = e.exec(a)) &&
                      ((d.pageMargin[0] = b.transformUnit(
                          c[1],
                          d.viewerHeight
                      )),
                      (d.pageMargin[1] = c[2]
        ...
        (n.prototype.calcVisiblePages = function () {
            ...
            if (this.isAnimating() && 0 !== c.pageMv[0]) {
                ...
                c.display == b.DISPLAY_SINGLE
                    ...
                    : c.display == b.DISPLAY_DOUBLE &&
                      (f[0] > 2 &&
                          ((g.pageV[f[0] - 2] = !0), (g.pageZ[f[0] - 2] = 1)),
                      f[1] < c.totalPages - 1 &&
        ...
        (n.prototype.options = function (c) {
            ...
            if (
                ...
                (c.margin || c.pageMargin) &&
                    (this._calculateMargin(), this._resize()),
        ...
        (n.prototype.direction = function (a) {
            ...
            return (
                "rtl" == a &&
                    this.$el.attr("dir", "ltr").css({ direction: "ltr" }),
                (c.direction = e),
        ...
        (n.prototype.stop = function () {
            ...
            if (this.isAnimating()) {
                ...
                for (c in d.pages)
                    b.has(c, d.pages) &&
                        d.pages[c].flip("_bringClipToFront", !1);
            return this.$el;
        }),
            ...
            for (var d in c.pages)
                if (b.has(d, c.pages) && c.pages[d].flip("_pagePress", a))
                    return (
                        c.tmpListeners ||
                            ((c.tmpListeners = {}),
                            (c.tmpListeners.tap = b.getListeners(
                                this.$el,
                                "tap",
                                !0
                            )),
            ...
            if (e.finger) {
                ...
                e.tmpListeners ||
                    ...
                    e.zoom > 1 &&
                        (!c ||
                            (c &&
                                1 ==
                                    d.originalEvent.originalEvent.touches
                                        .length)) &&
                        this.scroll(
                ...
                h.x < e.initCursor.x
                    ? (i.x =
                          ...
                          Math.max(
                              0,
                              (h.x - e.viewerOffset.left - 20) / e.initCursor.x
                          ))
                    : h.x > e.initCursor.x &&
                      (i.x =
                          e.initScroll.left +
                          (j.width - e.initScroll.left) *
                              Math.min(
                                  1,
                                  (h.x - e.initCursor.x + 20) /
                                      (e.viewerWidth - e.initCursor.x)
                              )),
                    h.y < e.initCursor.y
                        ? (i.y =
                              e.initScroll.top *
        ...
        (n.prototype._eventRelease = function (a) {
            ...
            if (
                ...
                delete d.finger,
                    ...
                    d.zoomed &&
                        (this.zoom(d.zoomed[0], d.zoomed[1]), delete d.zoomed);
            }
        }),
            ...
            if ("turning" != d.status && 1 == d.zoom && d.hasSelection == e)
                if (d.display == b.DISPLAY_SINGLE) {
                    ...
                    d.display == b.DISPLAY_DOUBLE &&
                        (c.speed < 0
                            ? this.isAnimating()
                                ? ~a.inArray(d.corner, b.corners.forward) &&
                                  this.next()
                                : this.next()
                            : c.speed > 0 &&
                              (this.isAnimating()
        ...
        (n.prototype.maxZoom = function () {
            ...
            if (a.options.responsive) {
                if (
                    "string" == typeof a.options.width &&
                    ~a.options.width.indexOf("%")
                )
                    return 1;
        ...
        (n.prototype._mouseRel = function (a) {
            ...
            if (d.display == b.DISPLAY_DOUBLE) {
                ...
                if (g[0]) {
                    ...
                    } else if (((f.x = f.x), f.x < 0 || f.x > e.width / 2))
                        return null;
                } else if (
                    ((f.x = f.x - e.width / 2), f.x < 0 || f.x > e.width / 2)
                )
                    return null;
            } else if (
                d.display == b.DISPLAY_SINGLE &&
        ...
        (n.prototype.zoom = function (c, d) {
            ...
            if ("pageX" in d && "pageY" in d) {
                ...
                (d = a.extend(d, h)),
                    "factor" in d &&
                        ((c = d.factor * e.fingerZoom), (d.animate = !1));
            } else
                ("x" in d && "y" in d) ||
                    ((d.x = g ? f.width / 4 : f.width / 2),
                    (d.y = f.height / 2));
            if (
                e.silentZoom ||
                ...
                var l = this.view(),
                    m = parseFloat(
                        Math.min(this.maxZoom(), Math.max(0.1, c)),
                        10
                    ),
                    n = this._position(m);
                b.vendor + "transition";
                ...
                t && !l[0] && (w.x -= r.width);
                var x =
                    b.translate(w.x - v.x, w.y - v.y, !0) + b.scale(m, m, !0);
                if ((this.stop(), this.disable(!0), this._cloneView(!0), o)) {
                    if (k > m)
                        for (i in e.pageWrap)
                            e.pageWrap[i].css({ visibility: "hidden" });
                    e.silentZoom = !0;
                    ...
                    e.zoomer.css(
                        ...
                        b.getTransitionEnd(e.zoomer, function () {
                            e.finger ||
                                j.zoom(c, { animate: !1, x: d.x, y: d.y });
                        });
                } else {
                    var z = e.peel;
                    if (
                        ...
                        e.zoomed = [
                            c,
                            { pageX: d.pageX, pageY: d.pageY, animate: !1 },
                        ];
                    } else {
                        for (i in e.pageWrap)
                            e.pageWrap[i].css({ visibility: "" });
                        (e.zoom = c),
                            (r = this._defaultSize()),
                            (r.width = r.width * m),
                            (r.height = r.height * m),
                            ...
                            this.size(
                                r.width,
                                r.height,
                                e.options.autoScaleContent
                            ),
                            this.scroll(v.x, v.y),
                            1 == m
                                ? (this.disable(!1),
                                  z && this.peel(z.corner, z.x, z.y, !0))
                                : (e.peel = z),
        ...
        (n.prototype._position = function (a) {
            ...
            if (
                ...
                (e.top < f[0] || e.top + d.height > b.viewerHeight - f[2]) &&
                    (e.top = f[0]),
                    (e.left < f[1] ||
                        e.left + d.width > b.viewerWidth - f[3]) &&
                        (e.left = f[3]);
            }
            return e;
        }),
        ...
        (n.prototype._cloneView = function (c) {
            var d = this._data;
            if (d.zoomer)
                c ? d.zoomer.show() : (d.zoomer.remove(), delete d.zoomer);
            else if (c) {
                var e,
                    f,
                    g,
        ...
        (q.prototype._pageCURL = function (a) {
            var c,
                ...
                C = function () {
                    ...
                    if (
                        ...
                        (i =
                            Math.sqrt(
                                Math.pow(J.x - a.x, 2) + Math.pow(J.y - a.y, 2)
                            ) / t),
                ...
                D = function (a, c, j, k) {
                    ...
                    if (
                        (r.ipage
                            .css(o)
                            .transform(
                                b.rotate(k) + b.translate(a.x + p, a.y, A),
                                q
                            ),
                        v.ipage
                            .css(o)
                            .transform(
                                b.rotate(k) +
                                    ...
                                    b.rotate(
                                        Math.round(100 * (180 / k - 2) * k) /
                                            100
                                    ),
                                q
                            ),
                        r.clip.transform(
                            b.translate(-a.x + m - p, -a.y + n, A) +
                                b.rotate(-k),
                            q
                        ),
                        v.clip.transform(
                            b.translate(w - a.x + x.x + m, -a.y + x.y + n, A) +
                                b.rotate(-k),
                            q
                        ),
                        s.options.gradients)
            ...
            switch (
                ((r.point = b.peelingPoint(a.corner, a.x, a.y)), a.corner)
            ) {
                case "l":
        ...
        (q.prototype._hardDouble = function (a) {
            ...
            if (
                ...
                c.igradient.parent()[0] != x.ipage[0] &&
                    c.igradient.appendTo(x.ipage),
    ...
    (r.prototype.value = function (a, c) {
        ...
        if (
            ...
            a != d.pvalue &&
                ...
                ((e =
                    100 *
                    ((a - d.options.min) / (d.options.max - d.options.min))),
                d.verticalStyle
            ...
            var f = c
                ? !0
                : this._trigger("changeValue", a) != b.EVENT_PREVENTED;
            f
                ? ((e =
                      100 *
                      ((a - d.options.min) / (d.options.max - d.options.min))),
    ...
    var s = b.UIComponent(function (c) {
        ...
        (d.pages = []),
            ...
            d.$flipbook.on(
                "changeDisplay",
                a.proxy(this, "_eventChangeDisplay")
            ),
            (d.done = !0);
    });
        ...
        (s.prototype._update = function (a, b) {
            ...
            if (
                !(
                    ...
                    ((e.prevFocusedPage = e.focusedPage),
                    (e.focusedPage = a),
                    e.disabled)
                )
            ) {
                ...
                for (
                    f = a;
                    (d = this._isPageVisible(f)) || (g && f <= e.totalPages);
            ...
            if (null === b) this._updatePageX(c, -1e3);
                ...
                d && b != c.pageNum
                    ? (g.removeClass("animated-page"),
                      this._updatePageX(
                          c,
                          this._getPageOffsetLeft(b, f.prevFocusedPage)
                      ),
                      setTimeout(function () {
        ...
        (s.prototype._setValues = function () {
            ...
            if (!a.disabled) {
                ...
                (b.width = b.width / a.$flipbook.turn("view").length),
                    ...
                    (a.pageWidth = Math.round(
                        a.pageHeight * (b.width / b.height)
                    )),
                    (a.pageMargin = 50),
        ...
        (s.prototype._eventRelease = function () {
            ...
            if (
                ...
                if (e > h) (c.offsetX = g - e), this._update(c.focusedPage, !0);
                    ...
                    (c.offsetX = g - f), this._update(c.focusedPage, !0);
                else {
                    var i = this,
    ...
    (t.prototype._eventDelegation = function (b) {
        ...
        (t.prototype._showHint = function (c) {
            ...
            if (d && "" !== d) {
                ...
                if (this._trigger("willShowHint", c) == b.EVENT_PREVENTED)
                    return;
                e.$currentTarget &&
                    (e.$currentTarget.removeClass("has-hint"),
        ...
        (t.prototype.options = function (b) {
            return void 0 === b
                ? this._data.options
                : ((this._data.options = a.extend(this._data.options, b)),
                  this.$el);
        }),
...
(function (window, $, Backbone) {
    ...
    var Regions = Backbone.Collection.extend({
        ...
        url: function () {
            return (
                FlipbookSettings.pageFolder + this.pageNumber + "/regions.json"
            );
        },
    ...
    var PageSliderView = SingleView.extend({
        ...
        _changeValueEvent: function (event, newPage) {
            ...
            if (
                $.inArray(currentVal, $("#flipbook").turn("view", newPage)) !=
                -1
            ) {
        ...
        show: function () {
            ...
            if (this._itemPage[currentPage] !== undefined) {
                ...
                if (this._itemPage[currentView[0]] !== undefined) {
                    this.$el.menu(
                        "selectItem",
                        this._itemPage[currentView[0]],
                        true
                    );
                } else if (this._itemPage[currentView[1]] !== undefined) {
                    this.$el.menu(
                        "selectItem",
                        this._itemPage[currentView[1]],
                        true
                    );
                } else {
    ...
    var ControlsView = SingleView.extend({
        ...
        initialize: function () {
            var eventNameToFade = Turn.isTouchDevice
                ? "vmousedown"
                : "vmousemove";
